...
.pull-left[
Instead of using classrooms `r emo::ji("backhand index pointing down")`
```{r out.width = '120%', echo = FALSE}
include_graphics("images/classroom.png")
```

`r emo::ji("backhand index pointing down")`
<br>
Remote and online learning `r emo::ji("backhand index pointing right")`
...
- Different knowledge and coding levels.
...
<br><br>
- Use Rstudio Cloud the entire semester

- Use Rstudio Cloud the first 4 weeks so that students are confident to use Rstudio in their local machines.
